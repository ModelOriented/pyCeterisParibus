...
if __name__ == "__main__":
    ...
    plot_bokeh(cp_profile, show_residuals=True)
    plot_d3(cp_profile, show_residuals=True)
    ...
    plot_bokeh(cp3, show_residuals=True)
    plot_d3(cp3, show_residuals=True)

    plot_bokeh(cp_profile, cp3, show_residuals=True)
    plot_d3(cp_profile, cp3, show_residuals=True)
